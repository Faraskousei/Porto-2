    ...
    <div className="min-h-screen relative bg-black scroll-smooth">
      ...
      <section id="about" className="relative z-10 py-12 sm:py-20 px-4 sm:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 sm:p-8 md:p-12">
            ...
            <p className="text-lg text-white/90 leading-relaxed">
              <TypeDecryptText
                text="My journey in web development started with curiosity and has evolved into a deep passion for creating digital experiences that not only look great but also provide real value to users."
                typeSpeed={30}
                decryptSpeed={20}
                maxIterations={1000}
                revealDirection="start"
      ...
      <section id="projects" className="relative z-10 py-12 sm:py-20 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-6 hover:bg-gray-700/50 transition-all duration-300 transform hover:scale-105">
      ...
      <section id="skills" className="relative z-10 py-12 sm:py-20 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {/* Next.js */}
            <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-6 text-center hover:bg-gray-700/50 transition-all duration-300 transform hover:scale-105 group">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mb-12 flex-wrap">
            ...
            <a 
              ...
              className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 group"
            >
