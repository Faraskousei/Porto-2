...
export default function Home() {
  return (
    <div className="min-h-screen relative bg-black scroll-smooth">
      ...
      {/* Header Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/10 backdrop-blur-xl border-b border-white/20 shadow-lg">
      ...
      <section id="about" className="relative z-10 py-12 sm:py-20 px-4 sm:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-black/10 backdrop-blur-xl rounded-2xl p-6 sm:p-8 md:p-12 border border-white/20 shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Cloud Storage System */}
              <div className="bg-black/10 backdrop-blur-xl rounded-xl p-4 sm:p-6 hover:bg-black/15 transition-all duration-300 transform hover:scale-105 border border-white/20 shadow-xl">
              <div className="w-full h-40 sm:h-48 bg-black/10 backdrop-blur-xl rounded-lg mb-4 flex items-center justify-center border border-white/20 shadow-lg">
      ...
      <section id="skills" className="relative z-10 py-12 sm:py-20 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {/* Next.js */}
            <div className="bg-black/10 backdrop-blur-xl rounded-xl p-4 sm:p-6 text-center hover:bg-black/15 transition-all duration-300 transform hover:scale-105 group border border-white/20 shadow-lg">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mb-12 flex-wrap">
            ...
            <a 
              ...
              className="w-14 h-14 sm:w-16 sm:h-16 bg-black/20 hover:bg-black/30 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 group backdrop-blur-xl border border-white/30 shadow-lg"
            >
